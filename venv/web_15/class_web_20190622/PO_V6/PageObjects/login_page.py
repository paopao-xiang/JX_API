...
from class_web_20190622.PO_V6.PageLocators.login_page_locator import LoginPageLocator as loc
from class_web_20190622.PO_V6.Common.basepage import BasePage
# 一个用例，一次浏览器的打开和结束。
